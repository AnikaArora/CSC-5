 ...
 * File:   main.cpp
 * Author: Anika Arora 
 * Created on 2/4/2020 at 2:46PM 
 * Purpose:  OverUnder7 version 4 
 */
...
int main(int argc, char** argv) {
    ...
    //Set-up game 
    cout<<"Welcome to the Over/Under 7 Game"<<endl; 
    cout<<"The local date and time is: "<<dt<<endl; 
    cout<<"What is your name?"; 
    cin>>name; 
    cout<<name<<", how much money would you like to start with? Choose between $1 and $10\n";
    cin>>money; 
    ...
    do {
        ...
        while (bet < 1 || bet > 3)
        {
            cout<<"That is an invalid bet, "<<name<<".\n"; 
            cout<<"What outcome would you like to bet on, "<<name<<"?"<<endl; 
            cout<<"1. Over 7 (1 to 1 odds)\n"; 
            cout<<"2. Under 7 (1 to 1 odds)\n"; 
            cout<<"3. Exactly 7 (5 to 1 odds)\n"; 
        ...
        if (money < 1)
        {
            cout<<"You ran out of money, "<<name<<".\n"; 
            cont = 'n'; 
        }
        else //check if user would like to continue the game 
        {
            cout<<"Would you like to continue, "<<name<<"? Enter 'y' for 'yes' and 'n' for 'no'.\n"; 
            cin>>cont; 
        }
    } while(cont == 'y' || cont == 'Y');
