 ...
 * Purpose:  Savitch; 9th Edition; Ch.1/Practice Programs/Q.4; create a logic error in display 1.8 
 */
...
int main( ) 
{
    ...
    total_peas = number_of_pods + peas_per_pod; //testing result of adding instead of multiplying (creates a logic error) 
